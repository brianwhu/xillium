...
public class CallBlock {
    public static void main(String[] args) throws Exception {
        if (args.length < 2) {
            System.err.println("Usage: CallableBlocks data-source.xml anonymous-sql-block.sql [ arguments ... ]");
            System.err.println("Usage: CallableBlocks data-source.xml anonymous-sql-block.xml:name [ arguments ... ]");
            System.exit(0);
        }
...
System.out.println(ps.getSQL());
        ...
        Class<? extends DataObject> c = ps.getDataObjectClass("lab.data.persistence.CallableBlocksParams");
        if (c != null) {
...
System.out.println("returned with "); System.out.println(Beans.toString(t));
            ...
            ps.executeProcedure(conn, (DataObject)null);
        }
