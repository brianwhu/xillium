...
/**
 * The PlatformAware interface marks a "bean" to receive a notification upon service module loading completion.
 */
public interface PlatformAware {
     ...
     * @param moduleName - the Xillium module name in which this PlatformAware is instantiated
	 */
	public void configure(String applName, String moduleName);

    /**
     * Invoked immediately after all PlatformAware objects are configured, this method should initialize the
